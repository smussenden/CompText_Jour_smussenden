...
if __name__ == "__main__":
    # Define year values here before running program from the command line
    # Uncomment and edit one of the options below
    # Example usage for one year
    year_values = ["1774"]
    # Example for two years 
    year_values = ["1774","1899"]
    # Example for a range of years (start and end years and all years in between for which there is data)
    #year_values = year_values + [str(year) for year in range(1798, 1964)]
    year_values = [str(year) for year in range(1962, 1964)]
