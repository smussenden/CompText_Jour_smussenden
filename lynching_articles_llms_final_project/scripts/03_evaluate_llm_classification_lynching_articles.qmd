...
test_data <- read_rds("../data/03_test_data/03_test_data.rds")
...
# Establish workers for parallel processing
# Standard is one less than number of cpu cores
...
chat <- chat_openai(model = "gpt-4-turbo", system_prompt = "I will pass you a malformed json object. You should fix any errors that will prevent this from returning true when passed directly through the jsonlite::validate() function in R.  Return only valid json and nothing more. You should always end and begin what you return with a curly brace, and no other character", echo = FALSE)
