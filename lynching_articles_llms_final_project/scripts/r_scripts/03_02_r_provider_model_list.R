...
# We're going to run these in parallel with a limited number of workers
# Probably three or four
# To avoid rate limits, spread out providers in the list 
# Hope is to avoid hitting two models from same provider at same time
