...
SF %>%
  filter(str_detect(disposition1, "No_Dispo|Gone"))
```
...
SF %>% 
  ...
  #Changes angle of x axis labels
  #coord_flip() +    #this makes it a horizontal bar chart instead of vertical
  labs(title = "Trends in Homeless Calls in San Francisco", 
       subtitle = "SF PD Service Call Data by Month 2017-2019",
       caption = "Graphic by Wells",
       y="Number of Calls",
       x="Year")  +
...
SF %>%
  mutate(day_of_week = wday(call_date2, label = TRUE)) %>%
  count(day_of_week) %>%
  ...
  #Changes angle of x axis labels
  #coord_flip() +    #this makes it a horizontal bar chart instead of vertical
  labs(title = "Homeless Calls by Day of the Week", 
       subtitle = "SF PD Service Call Data by Month 2017-2019",
       caption = "Graphic by Wells",
       y="Number of Calls",
       x="Day of the Week")  +
